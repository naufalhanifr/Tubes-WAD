    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h6 class="card-title">Data Jenis Kendaraan</h6>
                <a href="{{ route('jenis-kendaraan.create') }}" class="btn btn-sm btn-primary">Tambah Data</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('jenis-kendaraan.edit', $item->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                       <form action="{{ route('jenis-kendaraan.destroy', $item->id) }}" method="post" class="d-inline">
                                           @csrf
                                           @method('delete')
